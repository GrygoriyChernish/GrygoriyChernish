...
### 🏠 **HomeWorks Platform**
Fullstack learning platform with roles, tasks, analytics & clean API.  
**Stack:** Next.js, Prisma, PostgreSQL, Docker  
🔗 Demo: https://example.com  
💻 Code: https://github.com/GrygoriyChernish/project-1

### ⚡ **Real-Time Chat App**
Live chat with WebSockets, typing indicators & file sharing.  
**Stack:** Node.js, Express, Socket.io, Redis  
💻 Code: https://github.com/GrygoriyChernish/project-2
